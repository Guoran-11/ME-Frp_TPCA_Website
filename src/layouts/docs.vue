<template>
  <div class="min-h-screen" style="background: linear-gradient(135deg, #0F172A 0%, #111827 50%, #0A0E27 100%);">
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      <div
        class="absolute bottom-1/3 right-1/4 w-80 h-80 bg-blue-500/5 rounded-full blur-3xl animate-pulse-slow animation-delay-1000">
      </div>
    </div>
    ...
    <div class="flex pt-16 relative z-10">
      ...
      <!-- 移动端遮罩 -->
      <div v-if="sidebarOpen" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-30 lg:hidden"
